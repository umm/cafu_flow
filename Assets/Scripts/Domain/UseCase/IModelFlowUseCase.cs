...
namespace CAFU.Flow.Domain.UseCase {
    ...
    public class ModelFlowUseCase<TModel, TEntity, TEntityList, TModelTranslator>
        ...
        public new class Factory : DefaultUseCaseFactory<ModelFlowUseCase<TModel, TEntity, TEntityList, TModelTranslator>> {

            protected override void Initialize(ModelFlowUseCase<TModel, TEntity, TEntityList, TModelTranslator> instance) {
